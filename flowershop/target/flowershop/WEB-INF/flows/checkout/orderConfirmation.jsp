            ...
            <div class="row">
                ...
                <form:form commandName="order" class="form-horizontal">
                    ...
                    <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                       ...
                       <strong>Name:</strong> ${order.cart.customer.customerName}<br><br>
                        <div class="row">
                        ...
                        <div class="row">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItem}">
                                    <tr>
                                        <td class="col-md-2" style="text-align: center"><em>${cartItem.flower.fid}</em></td>
                                        <td class="col-md-2" style="text-align: center">${cartItem.quantity}</td>
                                        <td class="col-md-4" style="text-align: center"><i class="fa fa-inr" style="font-size:15px"></i> ${cartItem.flower.price}</td>
                                        <td class="col-md-2" style="text-align: center"><i class="fa fa-inr" style="font-size:15px"></i> ${cartItem.price}</td>
                                    </tr>
                                </c:forEach>
<tr></tr>
<tr></tr>
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong> <i class="fa fa-inr" style="font-size:16px"></i> ${order.cart.totalPrice}</strong></h4>
                                    </td>
                                </tr>
