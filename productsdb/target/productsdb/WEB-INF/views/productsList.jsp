...
<tr>
<td><a href="getProductById/${b.product_id}">${b.product_id}</a></td><td>${b.product_name}</td>
<td><a href="delete/${b.product_id}"><span class="glyphicon glyphicon-trash"></span></a></td>
</tr>
</c:forEach>
